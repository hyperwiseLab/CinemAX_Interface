package com.cinemax.infrastructure.gemini.service;
...
public interface GeminiService {
    ...
    // 채팅 요청
    GeminiChatResponse chat(GeminiChatRequest request);

    // 스트리밍 채팅 요청
    Flux<GeminiStreamResponse> chatStream(GeminiChatRequest request);

    // 컨텍스트 기반 대화
    GeminiChatResponse chatWithContext(List<ChatMessage> history, String userMessage);
